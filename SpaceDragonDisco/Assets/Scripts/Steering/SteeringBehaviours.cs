...
//Hi paul, most of this is from the repo you provided, I've added some extra bits and comments where required.
/*
...
public class SteeringBehaviours : MonoBehaviour {
    ...
    //Bools that allow us to toggle different behaviours directly in the inspector
	...
	void Update () 
	{
        //The spacebar will change the overlap radius, our space disco dragons will spreadout abit here in addition to other effects applied elsewhere
		ForceIntegrator();
